...
A real-valued transformer and a particular floating-point implementation are different references. A proof about real softmax does not automatically certify the output bits of FlashAttention, cuDNN, SDPA, vLLM, or SGLang. Even mathematically equivalent floating-point algorithms can disagree [R5].
...
## Implemented CUDA numerical profile
...
Primary sources are indexed in [RELATED_WORK.md](RELATED_WORK.md).
